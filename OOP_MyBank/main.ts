...
class Customer {
    ...
    constructor(fname:string, lname:string, gen:string,age:number,mobno:string){
...
class BankAccount extends Customer{
    accountNo :string ="BHKL" + Math.floor(Math.random()*100000000000);
    balance: number;
    constructor(fname:string, lname:string, gen:string,age:number,mobno:string,bala:number){
